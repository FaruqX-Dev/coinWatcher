...
import 'package:coin_watcher/features/auth/widget/password_strength.dart';
      ...
      content: SizedBox(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              const Text(
                "Terms and Conditions for Coin Watcher\n\n"
                "Privacy Policy\n"
                ...
                "Application refers to Coin Watcher, the software program provided by the Company.\n\n"
                "Company (referred to as either \"the Company\", \"We\", \"Us\" or \"Our\" in this Agreement) refers to Coin Watcher.\n\n"
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Icon(Icons.mail,color: Colors.blue,size: 20.0,),
                    Padding(
                      padding: const EdgeInsets.fromLTRB(8,25,8,8),
                      child: Text('Faruqbello0303@gmail.com\n',textAlign: TextAlign.center,style:  TextStyle(color: Colors.blue,fontSize: 14, height: 1.5,)),
                    ),
                  ],
                ),
              ),
              Text('Website: https://www.termsfeed.com/live/f3a59e67-b88d-4355-bd5b-971855aa6272',style: TextStyle(color: Colors.blue,fontSize: 14, height: 1.5),)
            ],
          ),
        ),
      ),
